      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-orange-500 to-yellow-400 p-12 flex-col justify-between">
        ...
        <div className="space-y-6 max-w-md">
          ...
          <p className="text-orange-50 text-lg">
            Create an account to discover popular spots, track crowd levels, and connect with others in your area.
          </p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center md:hidden">
            ...
            <p className="text-gray-600">Join the MingleMap community today</p>
          </div>
